...
const expected = [
  ...
  'src/packages/story/assets/story-03-partnership.jpg',
  'src/packages/story/assets/story-04-growth.jpg',
  'src/packages/story/assets/story-05-move.jpg',
  'src/packages/story/assets/story-06-wedding.jpg',
